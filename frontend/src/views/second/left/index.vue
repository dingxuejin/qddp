        ...
        <div class="sides-transition">
          <div class="inner-top">
            <Caption v-if="showTop"
                     ...
                     :leftCaption2='t_leftCaption2'
                     :rightCaption1='t_rightCaption1'
                     :rightCaption2='t_rightCaption2'
                     @updateData='updateDataTop' />
          </div>
...
export default {
  ...
  data() {
    return {
      t_leftCaption1: window.VUE_APP_Sec_L_1_1,
      t_leftCaption2:window.VUE_APP_Sec_L_1_2,
      t_rightCaption1: window.VUE_APP_Sec_L_2_1,
      t_rightCaption2: window.VUE_APP_Sec_L_2_2,
      b_leftCaption1: window.VUE_APP_Sec_L_3,
      b_rightCaption1: window.VUE_APP_Sec_L_4_1,
      b_rightCaption2: window.VUE_APP_Sec_L_4_2,
      showTop: false,
      showBottom: false
    };
  },
  methods: {
    updateDataTop(val) {
      if (val === "left1" || val === "left2" || val === "left3") {
        this.$refs.leftTop.change(val);
      }
      if (val === "right1" || val === "right2" || val === "right3") {
        this.$refs.rightTop.change(val);
      }
    },
